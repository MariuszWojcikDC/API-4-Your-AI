...
EXEC @ret = sys.sp_invoke_external_rest_endpoint @url = N 'https://<MS-FOUNDRY-ENDPOINT>.cognitiveservices.azure.com/openai/deployments/gpt-4o/chat/completions?api-version=2025-01-01-preview',
-- Can also be your local endpoint
@method = 'POST',
@payload = @body,
